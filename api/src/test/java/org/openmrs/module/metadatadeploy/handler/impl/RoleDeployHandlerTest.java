...
public class RoleDeployHandlerTest extends BaseModuleContextSensitiveTest {
	...
	public void integration() {
		...
		Role role1 = deployService
		        .installObject(role("Role1", "New desc", null, idSet("Privilege1"), "0689d5d0-e39b-11e4-b571-0800200c9a66"));
		Role role2 = deployService.installObject(role("Role2", "New desc", idSet("Role1"), idSet("Privilege2", "Privilege3"),
		    "20b709a0-e39b-11e4-b571-0800200c9a66"));
		Role role3 = deployService.installObject(
		    role("Role3", "New desc", idSet("Role1", "Role2"), idSet("Privilege4"), "29f97d90-e39b-11e4-b571-0800200c9a66"));
	...
	/**
	 * We previously encountered a problem where the session couldn't be flushed at certain stages
	 * during installation and re-installation of various roles and privileges. It seems like these
	 * objects can be cached via the UUID, and once we stopped needlessly overwriting UUIDs the
	 * problem was fixed.
	 */
	@Test
